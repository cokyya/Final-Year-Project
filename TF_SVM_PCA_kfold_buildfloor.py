...
plt.plot(class1_x, class1_y, '1', label='1st space')
plt.plot(class2_x, class2_y, '2', label='2nd space')
plt.plot(class3_x, class3_y, '3', label='3rd space')
plt.plot(class4_x, class4_y, '4', label='4th space')
plt.plot(class5_x, class5_y, '1', label='5th space')
plt.plot(class6_x, class6_y, '2', label='6th space')
plt.plot(class7_x, class7_y, '3', label='7th space')
plt.plot(class8_x, class8_y, '4', label='8th space')
plt.plot(class9_x, class9_y, '1', label='9th space')
plt.plot(class10_x, class10_y, '2', label='10th space')
plt.plot(class11_x, class11_y, '3', label='11th space')
plt.plot(class12_x, class12_y, '4', label='12th space')
plt.plot(class13_x, class13_y, '1', label='13th space')
plt.title('UJIIndoor_buildfloor_tensorflow_PCA=2_Gamma=4')
